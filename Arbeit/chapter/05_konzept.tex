...
\section{Ziele} \label{konzept/ziele}
{
	...
	% Beatzeitpunkte
	Au{\ss}erdem geben die Algorithmen von~\cite{2009_DaPlSt} und~\cite{2011_PlRoSt} zusätzlich noch Informationen zur Position des aktuellen oder nächsten Beats aus.
...
\section{Gestaltung der Tests} \label{konzept/gestaltung}
{
	...
	\subsection{Datenakquisition}
	{
		...
		Das ist bei diesem Algorithmus notwendig um die grö{\ss}e der CSV-Dateien zu reduzieren,
