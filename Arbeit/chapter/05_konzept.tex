...
\section{Gestaltung der Tests} \label{konzept/gestaltung}
{
	...
	\subsection{Datenauswertung}
	{
		...
		In der Datenauswertungskomponente der Testsoftware,
			werden lediglich die gepseicherten \acs{CSV}-Dateien verarbeitet.
		...
		\paragraph{Rechenzeit}
		{
			...
			Diese Zahl gibt an,
				wie viele Sekunden \acs{CPU}-Zeit ein Algorithmus benötigt um eine Sekunde Audiodaten zu verarbeiten
